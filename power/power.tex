...
\begin{figure}
  ...
  \label{fig:lesmis}
\end{figure}
To assess the quality of the divisive Girvan-Newman (GN) algorithm used by \citet{Jia2011}, it will be compared with \emph{agglomerative dissimilarity clustering}.
