...
The evaluation of this second hypothesis in general will therefore involve more exploratory analysis than the first.

\section{Results and analysis}
\label{sec:eco_results}

Here the data collected from the game will be explored to study the validity of the aforementioned hypotheses.
Data from a total of 842 players were analysed, from demographics of...

\subsection{Hypothesis 1}
\label{sec:hypothesis1}
Hypothesis 1 concerns the performance of players as they progressed through Learning World, depending on the type of visualisation they were presented with.
The visualisation with y-axis positions constrained to trophic level 
The first question to ask is: how many levels were players able to complete before quitting? This is answered in Figure~\ref{fig:player_progression}.
100,000 replicates, null hypothesis is no difference in median, permutation tests
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{joy/stars.pdf}
    \caption[Histograms showing player progressed]{Histograms showing how far players progressed through the game, for both the standard stress layout and trophically constrained groups. On the left is how many levels were completed, and on the right is how many stars were collected. The smooth curves denote a kernel density function over all bins, and the dotted vertical lines mark the median. The p-value of the trophic median being larger than the standard is written above each plot.}
    \label{fig:player_progression}
\end{figure}

There is a big cutoff at levels 8 and 9 - it seems they were likely too difficult.
The biggest proportion of players persevered and got to the end, which is nice.
It is clear that players got slightly further with a trophic layout than standard.
It is therefore not correct to test the total play time of players; in fact the median play time of trophic players was longer.
Because of this, the time taken will be analysed on a level by level basis

\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{joy/times.pdf}
    \caption[Histograms showing the time spent on each level]{Caption}
    \label{fig:level_times}
\end{figure}

Not many of these are statistically significant, as defined by p-values below 5\%. However, almost every level has a better median for trophic than standard.
The levels that it does do very well on are levels where there more than one trophic level is required.
Level 7 seems to be an anomaly. It is also the level that players completed fastest, and so should not really be taken seriously
This does not mean a shining recommendation for trophic, but it does show small and consistent improvement.

On the flip side, standard players did a little better on research world 101, with a p value of 0.096. This is likely due to the score metric requiring high connectance, and so food webs are especially crowded there, which means that a regular layout should prevail, due to the better spreading out of .
The remaining research world levels had little to no difference in median scores at all.
...
\begin{figure}
  ...
  \caption[Results from Research World level 1]{Caption}
  \label{fig:101}
\end{figure}
\begin{figure}
  \centering
  \includegraphics[height=.85\textheight, right]{joy/102.pdf}
  \caption[Results from Research World level 2]{Caption}
  \label{fig:102}
\end{figure}
\begin{figure}
  \centering
  \includegraphics[height=.85\textheight, right]{joy/103.pdf}
  \caption[Results from Research World level 3]{Caption}
  \label{fig:103}
\end{figure}
...
yes, data is messy as it is public
