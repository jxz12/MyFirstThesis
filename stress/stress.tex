...
Stress as an energy function is known to produce high-quality layouts~\cite{Brandes2009} without requiring extra input parameters such as those in Equation~\eqref{eq:eades}. However, it is known to be difficult to optimise due to an abundance of local minima~\cite{onedimensionalmds, hu}, and also does not scale well to larger graphs due to the quadratic number of terms in the summation~\cite{Brandes2009, Hu2005}.
