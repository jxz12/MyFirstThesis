...
Note that the results here also do not use PivotMDS \citep{Brandes2007Eigensolver} to initialize as done by \citet{Ortmann2017}, and instead initialize randomly within a 1$\times$1 square as before.
...
Their work especially shows the potential benefits of taking inspiration from the rapidly growing machine learning literature through usage of tools such as \texttt{tensorflow.js} \citep{Smilkov2019}.
