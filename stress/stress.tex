...
Another valid option is to set $\mu_{\max}$ to a value somewhere in between one and two. This will be used in Chapter~\ref{chap:joy}, Section~\ref{sec:eco_visualisation} for a real-world application, where it will be shown that it is in fact necessary for another domain-specific application in addition to the ones shown in Section~\ref{sec:cookbook}.
