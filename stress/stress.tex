...
However, stress as an energy function is also generally known to produce high-quality layouts~\cite{Brandes2009}. It also does not require extra input parameters such as those in Equation~\eqref{eq:eades} because $d_{ij}$ and $w_{ij}$ are both derived from the structure of the graph itself.
...
The difficulty in this can be clearly seen through a simple example... tetrahedron... LSR
