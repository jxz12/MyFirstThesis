...
To approximate the full model well it is important to choose pivots that are well distributed over the graph, and in their original paper \citet{Ortmann2017} present an experimental evaluation of various methods for doing so. The implementation here uses \textit{max/min random sp} to select pivots.
