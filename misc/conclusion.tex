...
% The practice of visualisation may sometimes even be considered to be just as much of an art as it is a science.
% It is difficult to define what art is, but one possible definition is the elucidation of meaning. A striking painting is sometimes needed to ask the question of what it means to be human. A moving song is sometimes the only avenue through which human emotions can be expressed and shared with others. A well-formed diagram is more than sometimes needed to understand the workings of the natural world. 
...
% The first three main chapters of this thesis each presented work on the foundational algorithms behind visualisation pipelines.
% Chapter~\ref{chap:stress}  
...
% \section{Future work}
% If the reader wishes to build on the work presented in this thesis, there are multiple avenues through which 
